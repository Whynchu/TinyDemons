...
| M8 Deep extraction | In progress | GPT-5.5, high | - | - | Walkability, overhead HUD, screen helpers/state, effects, and occlusion registration/cache/coverage/assembly helpers moved; screen layout, actor phase decisions, and interaction presentation remain |
