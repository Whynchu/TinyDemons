...
| M8 Deep extraction | In progress | GPT-5.5, high | - | - | Walkability collection/queries, overhead HUD refresh, effect/title-particle updates, HUD target/fill helpers, and occlusion image/cache/coverage helpers moved; screen construction, actor assembly, and interaction presentation remain |
