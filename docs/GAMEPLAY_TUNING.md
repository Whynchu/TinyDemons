...
| Regular enemy-room treasure | R1+ run ranks; 0.60 deterministic chance per combat room; rarity multipliers Rare/Epic/Legendary/Mythic = 0.50/0.40/0.25/0.20 relative to dedicated Treasure Rooms | `room_controller.gd:REGULAR_ROOM_TREASURE_CHANCE`, `gameplay.gd:_grant_chest_item_reward` |
