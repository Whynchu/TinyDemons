...
Current release: version `0.2.71`. The current smoke inventory is 135 manifest
rows / 133 runnable paths / 44-path default gate; the counts quoted in older
...
classifies all 135 scripts with a role (gate/owner/reference/diagnostic/report),
...
133 runnable paths. The 2026-09-13 pruning slice removed the stale
