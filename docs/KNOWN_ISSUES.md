...
Current release: version `0.2.71`. The current smoke inventory is 136 manifest
rows / 134 runnable paths / 44-path default gate; the counts quoted in older
...
classifies all 136 scripts with a role (gate/owner/reference/diagnostic/report),
...
134 runnable paths. The 2026-09-13 pruning slice removed the stale
