...
Current release: `0.2.06` (reproducible web export gate and reconciled touch/cloud contract evidence)
...
bound reachability, generated-layout, generated-scene, enemy spawn/walkability,
expanded elemental-binding, doorway, typed room-transition, and minimap
landmark/discovery checks in isolated Godot processes. The
...
risk/reward, bound reachability, generated-layout, generated-scene, enemy
spawn/walkability, doorway, typed room-transition, and minimap landmark/
discovery checks in isolated Godot processes. The starter-flame music
...
The 2026-09-13 focused Demon Hub and Equipment scene checks also pass. The Hub
check now has evidence for its animated nested Shop cursor contract, exact
sell-variant transaction, and pause separation; the Equipment check uses a
deterministic starter fixture and restores the saved profile after its live
mutations. Visual orientation comparison, touch swipes, and Shop performance
timing remain separate acceptance work.
