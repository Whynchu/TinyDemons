...
Current release: `0.2.20` (typed reward, checkpoint, room-state, runtime ownership, and long-term composition direction)
...
swipes, and Shop performance timing remain separate acceptance work.
