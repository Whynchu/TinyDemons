# Tiny Demons — Version 0.2.83 Codebase Audit
...
Current release: `0.2.83` (composition refactor structurally and editor-wise
...
## Current measured snapshot (2026-09-26, version 0.2.83)

The detailed historical audit below describes the `0.2.32` tree. The current
`0.2.83` working tree measures:

| Metric | 0.2.32 audit | 0.2.83 working tree (2026-09-26) |
| --- | ---: | ---: |
...
Tiny Demons 0.2.83 remains past the legacy-coupling and editor-composition
