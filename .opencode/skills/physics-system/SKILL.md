...
> **Related skills:** **component-system** for hitbox/hurtbox composition, **math-essentials** for collision math.
...
| `CharacterBody2D/3D` | Code | Players, enemies, NPCs (moved via `velocity` + `move_and_slide()`) |
