...
func _initialize() -> void:
	...
	if template != null and reference != null:
		...
		_expect(r4.markers.size() == 49, "New R4 contains its 49 authored overlays.", failures)
		...
		_expect(r4.marker_count(GRID_SCRIPT.MARKER_TREASURE_ROOM) == 9, "New R4 contains 9 Treasure Rooms.", failures)
