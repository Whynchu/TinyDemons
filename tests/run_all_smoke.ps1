...
$tests = @("composition_root_baseline_smoke", "run_grade_smoke", "progression_smoke", "item_economy_smoke", "rogue_slime_smoke", "speed_scale_smoke", "fusion_tooltip_smoke", "palette_smoke", "combat_momentum_smoke", "chroma_state_smoke", "chroma_pickup_smoke", "aspect_ability_smoke", "starter_flame_smoke", "actor_geometry_scene_smoke", "boss_geometry_scene_smoke", "input_router_smoke", "chroma_projectile_scene_smoke", "frame_time_smoke")
$failed = $false
