...
func _initialize() -> void:
	...
	var player := gameplay.get_node_or_null("Actors/Characters/PlayerPlacement/TinyDemon") as Sprite2D
	var attack_visual := gameplay.get_node_or_null("Actors/Characters/PlayerPlacement/TinyDemonAttack") as Sprite2D
	var animation := gameplay.get_node_or_null("Actors/Characters/PlayerPlacement/TinyDemon/Animation") as Node
