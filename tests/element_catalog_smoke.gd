...
func _initialize() -> void:
	...
	var neutral_damage_color := ElementCatalogScript.damage_number_color(e.NEUTRAL)
	_expect(neutral_damage_color.is_equal_approx(Color.WHITE), "Normal damage text is white", failures)
	var neutral_critical_color := ElementCatalogScript.damage_number_color(e.NEUTRAL, true)
	_expect(neutral_critical_color.is_equal_approx(Color.BLACK), "Normal critical damage text is black", failures)
