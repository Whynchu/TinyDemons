...
const DEFINITIONS := {
	...
	&"demon_cloak": {"name": "DEMON CLOAK", "slot": &"body", "tier_stat": "agility", "bonuses": {"defense": 3.0, "vitality": 2.0, "agility": 3.0}, "price": 200},
...
const DEFINITION_METADATA := {
	...
	&"demon_cloak": {"family": "cloak", "role_tags": ["agility", "defense", "vitality", "premium"], "primary_stat": "agility", "effects": {}, "source_tags": ["cloaked_demon"], "minimum_run_rank": 1, "minimum_player_level": 1, "rarity_floor": "common", "rarity_ceiling": "mythic", "shop_eligible": false, "fusion_group": "cloak", "visual_id": "cloak_demon", "description": "A living cloak from the Cloaked Demon. Only he sells it, and each one costs more than the last."},
