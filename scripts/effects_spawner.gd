...
func number_texture(text: String, color: Color) -> Texture2D:
	...
	var patterns := {
		# Route-result comparison glyphs. These are deliberately part of the
		# native pixel font so the result screen does not depend on a platform
		# font having Unicode arrow support.
		"▲": ["010", "111", "101", "101", "101"], "▼": ["101", "101", "101", "111", "010"], "=": ["111", "000", "111", "000", "000"],
