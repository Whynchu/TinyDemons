...
@onready var player: Sprite2D = $Actors/Characters/PlayerPlacement/TinyDemon
@onready var player_attack_visual: Sprite2D = $Actors/Characters/PlayerPlacement/TinyDemonAttack
@onready var player_shadow: Sprite2D = $Actors/Characters/PlayerPlacement/TinyDemonShadow
@onready var cloaked_demon_shadow: Sprite2D = $Actors/Characters/CloakedDemon/CloakedDemonShadow
...
@onready var chest: Sprite2D = $Actors/Props/Chest
@onready var rest_fire: Sprite2D = $Actors/Props/RestFire
@onready var rest_fire_depth_marker: Marker2D = $Actors/Props/RestFire/DepthMarker
@onready var cloaked_demon: Sprite2D = $Actors/Characters/CloakedDemon
@onready var cloaked_demon_depth_marker: Marker2D = $Actors/Characters/CloakedDemon/DepthMarker
...
@onready var player_stats: StatsComponent = $Actors/Characters/PlayerPlacement/TinyDemon/Stats
...
var current_room_route_role: StringName = DungeonGraph.ROUTE_MAIN
var current_room_encounter_tier: StringName = DungeonGraph.ENCOUNTER_NORMAL
...
func _show_fire_exchange_text(text: String, color: Color) -> void:
	_spawn_player_number(text, 0, color, false, text)
