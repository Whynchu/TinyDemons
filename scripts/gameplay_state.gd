...
@onready var player: Sprite2D = $Actors/PlayerPlacement/TinyDemon
@onready var player_attack_visual: Sprite2D = $Actors/PlayerPlacement/TinyDemonAttack
@onready var player_shadow: Sprite2D = $Actors/PlayerPlacement/TinyDemonShadow
...
@onready var player_stats: StatsComponent = $Actors/PlayerPlacement/TinyDemon/Stats
