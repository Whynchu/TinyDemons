...
func build(parent: Node) -> void:
	...
	root.screen_state_controller.create_sprite(overlay, "CloudSaveTitle", pixel_texture.call("CLOUD SAVE", Color8(148, 220, 255)) as Texture2D, Vector2(12, 7), false)
	root.screen_state_controller.create_sprite(overlay, "CloudSaveHelp", pixel_texture.call("KEEP YOUR RECOVERY KEY SAFE", Color8(150, 156, 170)) as Texture2D, Vector2(12, 24), false)
