...
func _update_archetype_screen() -> void:
	...
	if not player_idle_frames.is_empty():
		...
		archetype_preview.texture = archetype_preview_frames[0]; archetype_preview.position = Vector2((240.0 - archetype_preview.texture.get_width() * archetype_preview.scale.x) * 0.5, 31)
...
func _update_archetype_preview_animation() -> void:
	...
	archetype_preview.texture = archetype_preview_frames[frame_index]; archetype_preview.position = Vector2((240.0 - archetype_preview.texture.get_width() * archetype_preview.scale.x) * 0.5, 31)
