...
func update_slime_notices(_root: Object, delta: float) -> void:
	for index in range(slime_notice_effects.size() - 1, -1, -1):
		...
		marker.global_position = slime.global_position + Vector2(8.0, -11.0 - 13.0 * (encounter_scale - 1.0) - progress * 3.0)
...
func number_texture(text: String, color: Color) -> Texture2D:
	...
	var patterns := {
		"+": ["000", "010", "111", "010", "000"], "-": ["000", "000", "111", "000", "000"], ":": ["0", "1", "0", "1", "0"], "!": ["010", "010", "010", "000", "010"], ".": ["0", "0", "0", "0", "1"], "/": ["001", "001", "010", "100", "100"],
		...
		"G": ["111", "100", "101", "101", "111"], "H": ["101", "101", "111", "101", "101"], "K": ["101", "110", "100", "110", "101"], "P": ["110", "101", "110", "100", "100"], "W": ["10101", "10101", "10101", "11011", "01010"], "A": ["010", "101", "111", "101", "101"], "B": ["110", "101", "110", "101", "110"], "M": ["10001", "11011", "10101", "10001", "10001"], "E": ["111", "100", "110", "100", "111"], "O": ["111", "101", "101", "101", "111"], "V": ["101", "101", "101", "101", "010"], "X": ["101", "101", "010", "101", "101"], "?": ["110", "001", "010", "000", "010"], "<": ["001", "010", "100", "010", "001"], ">": ["100", "010", "001", "010", "100"], " ": ["0", "0", "0", "0", "0"]
		,"x": ["000", "000", "101", "010", "101"], "p": ["000", "110", "101", "110", "100"], "l": ["100", "100", "100", "100", "110"], "v": ["000", "000", "101", "101", "010"]
	}
	var image_width := 0
	for digit in text:
